/*
欧几里得几何有时单指平面上的几何，即平面几何。欧式空间（笛卡尔空间）描述2D/3D很适合，但不是和处理透视空间
欧氏几何是透视几何的一个子集合
平面笛卡尔坐标系：是直角坐标系和斜坐标系的统称。相交于原点的两条数轴，构成了平面放射坐标系。如两条数轴上的度量单位相等，则称此放射坐标系为笛卡尔坐标系。两条数轴互相垂直的笛卡尔坐标系，称为笛卡尔直角坐标系，否则称为笛卡尔斜角坐标系。
空间笛卡尔坐标系：放射坐标系和笛卡尔坐标系由平面向空间的推广：相交于原点的三条不共面的数轴构成空间的放射坐标系。三条数轴上度量单位相等的放射坐标系被称为空间笛卡尔坐标系。三条数轴互相垂直的笛卡尔坐标系被称为空间笛卡尔直角坐标系，否则被称为空间笛卡尔斜角坐标系。
